...
function FileSignIcon({ className = "w-6 h-6" }: { className?: string }) {
    return (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}
            strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <div className="premium-card space-y-5">
            ...
            <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-btn flex items-center justify-center flex-shrink-0 shadow-card-md">
                    <FileSignIcon className="w-6 h-6 text-white" />
                </div>
                <div>
                    <div className="flex items-center gap-2">
                        <h2 className="text-base font-bold text-kyc-text leading-tight">Agreement</h2>
                    ...
                    <p className="text-sm text-kyc-muted mt-0.5">Upload your signed agreement document</p>
                </div>
            </div>
