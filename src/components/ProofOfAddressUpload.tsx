        ...
        <div className="premium-card space-y-5">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <div className="flex items-center gap-2">
                        <h2 className="text-base font-bold text-kyc-text leading-tight">Proof of Address</h2>
                    ...
                    <p className="text-sm text-kyc-muted mt-0.5">
                        Utility bill, government letter, or bank statement
                    </p>
                </div>
            </div>
            ...
            <div className="p-3.5 bg-kyc-bg-2 border border-kyc-border rounded-xl">
                <p className="text-xs text-kyc-muted leading-relaxed">
                    Document must show your full name and residential address, and be dated
                    <strong className="text-kyc-text-2"> within the last 3 months</strong>.
                </p>
            </div>
