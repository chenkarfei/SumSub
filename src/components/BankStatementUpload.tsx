    ...
    return (
        <div className="card-mobile">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h2 className="text-lg font-semibold text-kyc-text">Bank Statement</h2>
                    <p className="text-sm text-kyc-muted">Step 4 of 5</p>
                </div>
            </div>

            <p className="text-sm text-kyc-muted mb-6">
                Please upload your most recent bank statement (within the last 3 months). Accepted formats: PDF, JPG, PNG — max 10 MB.
            </p>
